// LinuxSDLDrawPlugin.h
//
//      Abstract class with basic drawing functionality
//
/////////////////////////////////////////////////////////////////////////////

#ifndef _LINUX_SDL_DRAW_PLUGIN_H_
#define _LINUX_SDL_DRAW_PLUGIN_H_

#include "IDrawPlugin.h"
#include "SDL.h"
#include "util/INotificationSuscriber.h"

class LinuxSDLDrawPlugin: public IDrawPlugin,public INotificationSuscriber<IPalette>
{
protected:
	bool _isInitialized;
public:
	LinuxSDLDrawPlugin();
	 virtual ~LinuxSDLDrawPlugin(){}
...
#endif // _LINUX_SDL_DRAW_PLUGIN_H_
